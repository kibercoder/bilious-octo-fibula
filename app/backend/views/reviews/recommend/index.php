 ...
 * @var common\models\RecommendSearch $searchModel
 */

$this->title = Yii::t('app', 'Recommends');
...
[
                ...
                'value' => function($model) {
                    //return Html::img( $model->getUploadUrl('photo_image'), ['width'=>'100']);
                    if (!file_exists('.'.$model->photo_image)){
                      return Html::img( $model->photo_image, ['width'=>'100']);
                    }
                },
            ],
            'list_order',
