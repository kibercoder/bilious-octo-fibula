...
use common\models\DiagnosSearch;
...
/**
 * DiagnosController implements the CRUD actions for Diagnos model.
 */
class DiagnosController extends Controller
{
    ...
    /**
     * Lists all Diagnos models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DiagnosSearch;
    ...
    /**
     * Displays a single Diagnos model.
     * @param integer $id
     * @return mixed
     */
     /*
    ...
    /**
     * Updates an existing Diagnos model.
    ...
    /**
     * Deletes an existing Diagnos model.
    ...
    /**
     * Finds the Diagnos model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Diagnos the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Diagnos::findOne($id)) !== null) {
            return $model;
        } else {
